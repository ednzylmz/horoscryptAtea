...
def captioner(textkey , textregion, input_file = './artifacts/input.wav' , output_file = './artifacts/output.vtt') :
    user_config = {}
    user_config["subscription_key"] = textkey
    user_config["region"] = textregion
    user_config["input"] = "../artifacts/input.mp3"
    user_config["recognizing"] = 1
    user_config["threshold"] = 5
    user_config["profanity_option"] = "Masked"
    user_config["phrases"] = "meeting;conference;lunch"
    user_config["output_file"] = output_file
    user_config["srt"] = 1
    user_config["use_sub_rip_text_caption_format"] = 0
    user_config["suppress_console_output"] = 0
    user_config["input_file"] = input_file
    user_config["use_compressed_audio"] = 0
    user_config["language_ID_languages"] = "en-US"
    user_config["stable_partial_result_threshold"] = None
    user_config["phrase_list"] = None
    user_config["show_recognizing_results"] = 0
