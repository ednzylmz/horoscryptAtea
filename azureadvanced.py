...
def summarizer(input_file = './artifacts/output.vtt'):
    ...
    def sample_extractive_summarization(client, sum = ''):
        from azure.core.credentials import AzureKeyCredential
        from azure.ai.textanalytics import (
            TextAnalyticsClient,
    ...
    summary = sample_extractive_summarization(client)
